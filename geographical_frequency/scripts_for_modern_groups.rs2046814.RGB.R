...
library(mapplots)
library(plotrix)
data <- read.table("Frequencies_in_modern_groups.rs2046814.txt", header=T)

pdf("Frequencies_in_modern_groups.rs2046814.pdf",h=4.5,w=9)
par(mar=c(0.1,0.1,0.1,0.1))
map("world", interior=FALSE)
cbPalette <- c("#999999", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7")
legend(x=-165, y=-35, legend=c("T","G"), col=c("orange","blue"), bty="n", pch=15, cex=1)
...
add.pie(x=data[i,2], y=data[i,3], z=c(data[i,4], data[i,5]), col=c("blue","orange"), labels="", radius=5, border=cbPalette[4])
